    ...
    extend: {
      colors: {
        primary: {
          ...
          900: '#312e81',
          950: '#1e1b4b',
          // Electric cyan (dark) / deep cyan (light), driven by CSS variables.
          DEFAULT: 'rgb(var(--primary) / <alpha-value>)',
        },
        // Semantic esport tokens (see globals.css). Theme-aware via CSS variables.
        surface: {
        ...
        line: {
          subtle: 'rgb(var(--line-subtle) / var(--line-subtle-a))',
          strong: 'rgb(var(--line-subtle) / var(--line-strong-a))',
        },
        ink: {
        ...
        'form-strokedark': '#2E3B5C',
        'form-input': '#141B2E',
        meta: {
          1: '#DC3545', 2: '#EFF2F7', 3: '#10B981', 4: '#182034', 5: '#259AE6',
      ...
      fontFamily: {
        ...
        display: ['Chakra Petch', 'Space Grotesk', 'Poppins', 'sans-serif'],
