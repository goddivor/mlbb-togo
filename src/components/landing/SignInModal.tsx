            ...
            {mode === 'choice' ? (
              <div className="space-y-4">
                ...
                <button
                  onClick={googleLogin}
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 py-3.5 rounded-lg font-semibold bg-white text-gray-800 hover:bg-gray-100 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {loading ? (
                  ...
                  {loading ? t('signin.connecting') : t('signin.google')}
                </button>
              </div>
            ) : (
