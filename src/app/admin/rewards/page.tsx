...
import { Gem, Hourglass, Medal, Milestone, UserSearch } from 'lucide-react';
...
type Tab = 'timeline' | 'frames' | 'temporary' | 'player' | 'tournaments';
const TABS: Tab[] = ['timeline', 'frames', 'temporary', 'player', 'tournaments'];
...
export default function AdminRewardsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs variant="underline" tabs={tabs} active={tab} onChange={setTab} />
