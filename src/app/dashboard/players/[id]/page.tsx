...
export default function PublicProfilePage() {
  ...
  const backLink = (
    <Link href="/dashboard/players" className="inline-flex items-center gap-1.5 text-sm font-medium text-ink-2 transition-colors hover:text-ink-1">
                ...
                {fstatus === 'friends' && (
                  <>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/dashboard/messages?to=${id}&name=${encodeURIComponent(user.displayName || user.username)}`,
                        )
                      }
                    >
